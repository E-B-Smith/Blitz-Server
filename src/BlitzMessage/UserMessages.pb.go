...
func (UserMessageType) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (UserMessageStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*UserMessage) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*UserMessageUpdate) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }

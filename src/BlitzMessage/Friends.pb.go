...
func (FriendStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*Friend) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*FriendUpdate) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*FriendRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*AcceptInviteRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func (*AcceptInviteResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4} }

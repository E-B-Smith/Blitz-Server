...
type BlitzHereOptions struct {
	XXX_unrecognized []byte `json:"-"`
}

func (m *BlitzHereOptions) Reset()         { *m = BlitzHereOptions{} }
func (m *BlitzHereOptions) String() string { return proto.CompactTextString(m) }
func (*BlitzHereOptions) ProtoMessage()    {}
...
type AppOptions_BlitzHereOptions struct {
	BlitzHereOptions *BlitzHereOptions `protobuf:"bytes,1,opt,name=blitzHereOptions,oneof"`
}
...
func (m *AppOptions) GetBlitzHereOptions() *BlitzHereOptions {
